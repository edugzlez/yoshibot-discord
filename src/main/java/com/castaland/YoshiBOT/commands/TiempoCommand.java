    ...
    public void execute(MessageReceivedEvent event, List<String> args) {
        if (event.getChannelType() == ChannelType.TEXT) { // verifies if channel is textchannel
            ...
            try {
                ...
                int candeleda_temperatura = data_candeleda.getInt("temperatura_actual");
                String candeleda_cielo = data_candeleda.getJSONObject("stateSky").getString("description");
                String candeleda_cielo_id = data_candeleda.getJSONObject("stateSky").getString("id");
                String candeleda_cielo_icon = "";

                if (codes.containsKey(candeleda_cielo_id)) candeleda_cielo_icon = codes.get(candeleda_cielo_id);
                else candeleda_cielo_icon = ":white_small_square:";

                int madrid_temperatura = data_madrid.getInt("temperatura_actual");
                String madrid_cielo = data_madrid.getJSONObject("stateSky").getString("description");
                String madrid_cielo_id = data_madrid.getJSONObject("stateSky").getString("id");
                String madrid_cielo_icon = "";

                if (codes.containsKey(madrid_cielo_id)) madrid_cielo_icon = codes.get(madrid_cielo_id);
                else madrid_cielo_icon = ":white_small_square:";
